...
#refactored code
#estoy creando un diccionario que tiene como keys los numeros con letra y el valor en int, esto me va a servir para poder convertir el input del usuario en entero
numeros = {
    'zero':0,
    'one':1,
    'two':2, 
...
#esta función recibe 3 argumentos, los cuales son la operacion y los valores numericos
def op(operation, a, b):
    #el if, se usa para comprobar si la operacion es resta, el elif, si es suma y el caso else, por si aparece algo diferente de esas dos opciones, no importa como es que lo ingrese desde el teclado, mayusculas, minusculas o mezclado, todo lo convierte a minuscula y lo compara para hacer la operacion
...
#mensaje de bienvenida, se ejecuta igual que el original
print('Welcome to this calculator!')
print('It can add and subtract whole numbers from zero to five')
a = input('Please choose your first number (zero to five): ')
b = input('What do you want to do? plus or minus: ')
...
#solo hacemos uso de la funcion op pasandole los 3 parametros
